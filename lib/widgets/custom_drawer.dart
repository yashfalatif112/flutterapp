      ...
      child: Container(
        ...
        child: ListView(
          ...
          children: [
            ...
            _buildDrawerItem(
                Icons.card_giftcard, "Credits, promos and gift card"),
            _buildDrawerItem(Icons.receipt_long, "My Orders"),
            _buildDrawerItem(Icons.bookmark, "Favorites"),
            _buildSectionTitle("GIFT-ON-DEMAND"),
            _buildDrawerItem(Icons.card_giftcard, "Gift Card"),
            _buildSectionTitle("NETWORK"),
            _buildDrawerItem(Icons.flight_takeoff, "Boss Up Now"),
            _buildDrawerItem(Icons.home, "Become home easer"),
            ...
            _buildDrawerItem(Icons.info_outline, "How It's Works"),
